...
(async () => {
  ...
  try {
    ...
    const description = "Deflationary Proposal: Burn " + amount + " MasonDAO tokens as deflationary measure? ";
    const executions = [
      {
    ...
    console.log(
      "✅ Successfully created proposal to destroy funds from the treasury, let's hope people vote for it!"
    );
  } catch (error) {
